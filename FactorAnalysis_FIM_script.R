...
#Mac
data<-read.csv("/Users/LeoPestillo/Google Drive/Life Discussions/Tz_Validations/Tz_MHpostTBI_data.csv",sep=',')
...
#FIM
FIM_data1<-with(data_validation,data.frame(g1,g2,g3,g4,g5,g6,g8,g9,g10,g11,g12,g14,g15,g17,g18,g22,g26,g27))
...
#FIM Motor
FIM_Motor<-with(FIM_data,data.frame(g1,g2,g3,g4,g5,g6,g8,g9,g10,g11,g12,g14,g15))

#FIM Cognitive
FIM_Cognitive<-with(FIM_data,data.frame(g17,g18,g22,g26,g27))
...
psych::alpha(FIM_Motor,n.iter=1000,check.keys=TRUE)
psych::alpha(FIM_Cognitive,n.iter=1000,check.keys=TRUE)
...
#RELIABILITY
#psych::alpha(cor_data,n.iter=1000,check.keys=TRUE)
psych::alpha(FIM_data30,n.iter=1000,check.keys=TRUE)
psych::alpha(FIM_Motor30,n.iter=1000,check.keys=TRUE)
psych::alpha(FIM_Cognitive30,n.iter=1000,check.keys=TRUE)
...
cor_data<-cor_auto(FIM_data30) 

#extract thresholds
polycor_data<-polychoric(na.omit(FIM_data30),correct=.01) # crossvalidate
...
kmo<-kmo(na.omit(FIM_data30)) #Run the Kmo function for the data you want to calculate
kmo$overall
kmo$AIR #anti-image matrix

cortest.bartlett(cor_auto(FIM_data30), n = 192,diag=FALSE)
...
# scree(cor_data)
# VSS.scree(cor_data)
fa.parallel(FIM_data30,cor="poly")
...
# 2 factor model
cfa_model <- '
MF =~ g1 + g2 + g3 + g4 + g5 + g6 + g8 + g9 + g10 + g11 + g12 + g14 + g15
...
# 1 factor model
cfa_model <- '
MF =~ g1 + g2 + g3 + g4 + g5 + g6 + +g7 + g8 + g9 + g10 + g11 + g12 + g13 + g14 + g15 + g16 + g17 + g18 + g19 + g20 + g21 + g22 + g23 + g24 + g25 + g26 + g27 + g28 + g29 + g30
g19 ~~ g20
#g21 ~~ g22
g4 ~~  g5
#g7 ~~ g28
...
#Factor scores
FIM_data30<-lavaan::predict(fit)

write.csv(FIM_data30, "/Users/LeoPestillo/Desktop//FIM_data.csv")
