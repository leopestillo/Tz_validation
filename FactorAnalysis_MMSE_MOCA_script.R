...
#Desktop
data<-read.csv("D:/Google Drive/Life Discussions/Tz_Validations/Tz_MHpostTBI_data.csv",sep=',')

#Mac
data<-read.csv("/Users/LeoPestillo/Google Drive/Life Discussions/Tz_Validations/Tz_MHpostTBI_data.csv",sep=',')


data<-read.csv("/Users/leonardo.oliveira/Documents/Leonardo/Analysis/Tz_MHpostTBI_data.csv",sep=',')
...
data<-read.csv("/Users/LeoPestillo/Google Drive/Life Discussions/Tz_Validations/Data_correlation.csv",sep=',')

#subsetting data set to keep only baseline data
data_validation<-subset(data[data$redcap_event_name=="enrollment_arm_1",])

cor_data<-cor_auto(data_validation) 
